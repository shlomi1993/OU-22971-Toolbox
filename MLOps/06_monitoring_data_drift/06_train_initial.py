...
Unit 06: initial training on a reference month.

Example:
  python 06_train_initial.py --data-parquet TLC_data/green_tripdata_2020-01.parquet
"""
...
def main() -> None:
    ...
    with mlflow.start_run(run_name=run_name):
        ...
        mlflow.log_params({
            ...
            "data_path": str(args.data_parquet),
        })
