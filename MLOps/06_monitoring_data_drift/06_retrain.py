...
Unit 06: retrain workflow (short + clean).
...
Example:
  python 06_retrain.py --train-parquets TLC_data/green_tripdata_2020-01.parquet TLC_data/green_tripdata_2020-04.parquet --eval-parquet TLC_data/green_tripdata_2020-08.parquet
"""
...
def parse_args() -> argparse.Namespace:
    ...
    p.add_argument("--train-parquets", nargs="+", required=True)
...
def main() -> None:
    ...
    train_paths = [Path(p) for p in args.train_parquets]
