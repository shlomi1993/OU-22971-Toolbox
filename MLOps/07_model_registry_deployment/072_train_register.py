"""
072_train_register.py

Unit 07: train + register + alias two simple sklearn regressors in MLflow Model Registry.
...
def main() -> None:
    ...
    client.set_registered_model_tag(args.model_name, "unit", "07")
