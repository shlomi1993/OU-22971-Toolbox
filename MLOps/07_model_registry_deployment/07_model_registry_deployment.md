# 07 — Model Registry, promotion, and deployment 
...
- `production` — the model production deployments should serve
...
Look here for details: https://mlflow.org/docs/latest/ml/deployment/
...
## Lookback at Unit 06 (drift + retrain)

Unit 06 currently scans runs to find a “latest model”.
