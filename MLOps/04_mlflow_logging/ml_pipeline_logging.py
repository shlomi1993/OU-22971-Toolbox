...
- MLflow logging: params / metrics / artifacts / dataset provenance / model
...
def train_and_evaluate(df: pd.DataFrame) -> None:
    ...
    # ---- MLflow: params / metrics / artifacts / model / gridsearch results
    ...
    mlflow.log_metric("test_macro_f1", float(f1_score(y_test, y_pred, average="macro")))
